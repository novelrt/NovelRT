...
TEST(BitCastTest, CastGlmVec2ToNovelRTGeoVector2F)
{
    ...
    GeoVector2F nrtVec2 = BitCast<GeoVector2F>(glmVec2);
...
TEST(BitCastTest, CastGlmVec3ToNovelRTGeoVector3F)
{
    ...
    GeoVector3F nrtVec3 = BitCast<GeoVector3F>(glmVec3);
...
TEST(BitCastTest, CastGlmVec4ToNovelRTGeoVector4F)
{
    ...
    GeoVector4F nrtVec4 = BitCast<GeoVector4F>(glmVec4);
...
TEST(BitCastTest, CastGlmMat4ToNovelRTGeoMatrix4x4)
{
    ...
    GeoMatrix4x4F nrtMat4x4 = BitCast<GeoMatrix4x4F>(glmMat4);
