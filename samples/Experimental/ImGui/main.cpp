...
int main()
{
    ...
    auto inputDevice = std::make_shared<NovelRT::Input::Glfw::GlfwInputDevice>();
    ...
    //ImGui stuff before getting surface
    auto imGuiProvider = new NovelRT::UI::DearImGui::ImGuiUIProvider<VulkanGraphicsBackend>();
