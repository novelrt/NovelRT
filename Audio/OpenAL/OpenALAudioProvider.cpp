...
namespace NovelRT::Audio
{
    ...
    {
        using callbackType = ALC_APIENTRY void(void* userptr, char level, const char* message, int length) noexcept;
        using fnType = ALC_APIENTRY void(callbackType* callback, void* userptr);
