...
export module NovelRT.Maths:GeoVector2F;

import NovelRT.Utilities;
...
namespace NovelRT::Maths
{
    ...
    public:
        ...
        {
            return *reinterpret_cast<const glm::vec2*>(this) == NovelRT::Utilities::BitCast<glm::vec2>(other);
        }
        ...
        inline GeoVector2F& operator+=(GeoVector2F other) noexcept
        {
            *reinterpret_cast<glm::vec2*>(this) =
                *reinterpret_cast<const glm::vec2*>(this) + NovelRT::Utilities::BitCast<glm::vec2>(other);
            return *this;
        }
        ...
        [[nodiscard]] bool EpsilonEquals(GeoVector2F other, GeoVector2F epsilonValue) const noexcept
        {
            return glm::all(glm::equal(*reinterpret_cast<const glm::vec2*>(this),
                                       NovelRT::Utilities::BitCast<glm::vec2>(other),
                                       NovelRT::Utilities::BitCast<glm::vec2>(epsilonValue)));
        }
     ...
     * \f}
     *
     * This is a pure method. Calling this without using the result has no effect and introduces overhead for calling a
     * method.
     *
     * @param lhs The scalar that gets multiplied by the GeoVector2F's components.
     * @param rhs The GeoVector2F whose components get multiplied by the scalar.
