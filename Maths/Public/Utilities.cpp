...
export module NovelRT.Maths:Utilities;
...
namespace NovelRT::Maths::Utilities
{
     ...
     */
    export [[nodiscard]] constexpr std::array<uint8_t, 32> Log2DeBruijn() noexcept
    {
     ...
     */
    export [[nodiscard]] constexpr bool IsPow2(size_t value) noexcept
    {
     ...
     */
    export [[nodiscard]] constexpr size_t AlignUp(size_t address, size_t alignment)
    {
     ...
     */
    export [[nodiscard]] constexpr int32_t PopCount(uint32_t value) noexcept
    {
#if __cpp_lib_bitops
     ...
     */
    export [[nodiscard]] constexpr uint32_t Log2(uint32_t value) noexcept
    {
        value |= value >> 1;
        value |= value >> 2;
        value |= value >> 4;
     ...
     */
    export [[nodiscard]] constexpr uint32_t LeadingZeroCount32(uint32_t value) noexcept
    {
#if __cpp_lib_bitops
     ...
     * @return The amount of leading zeros.
     */
    export [[nodiscard]] constexpr uint64_t LeadingZeroCount64(uint64_t value) noexcept
    {
#if __cpp_lib_bitops
        return std::countl_zero(value);
#else
     ...
     */
    export [[nodiscard]] float DegreesToRadians(float degrees) noexcept
    {
     ...
     */
    export [[nodiscard]] float RadiansToDegrees(float radians) noexcept
    {
