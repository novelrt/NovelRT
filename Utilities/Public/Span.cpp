...
export module NovelRT.Utilities:Span;

namespace NovelRT::Utilities
{

#ifdef NOVELRT_USE_STD_SPAN
    export const size_t DynamicExtent = std::dynamic_extent;
#else
    export const size_t DynamicExtent = gsl::dynamic_extent;
#endif

    export template<class T, std::size_t Extent = DynamicExtent>
#ifdef NOVELRT_USE_STD_SPAN
    ...
    export template<typename TTo, typename TFrom, std::size_t NFrom>
