...
function(install_dependency_outputs)
  ...
  if(NOVELRT_GENERATOR_IS_MULTI_CONFIG)
    foreach(INSTALL_DEPENDENCY_OUTPUTS_CONFIG IN LISTS CMAKE_CONFIGURATION_TYPES)
...
[[@INSTALL_DEPENDENCY_OUTPUTS_CONFIG_PREFIX@if("${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "@INSTALL_DEPENDENCY_OUTPUTS_CONFIG_REGEX@")]]
      ...
      foreach(INSTALL_DEPENDENCY_OUTPUTS_FILEPATH IN LISTS INSTALL_DEPENDENCY_OUTPUTS_FILES)
        ...
        string(REPLACE "${CMAKE_CFG_INTDIR}/" "${INSTALL_DEPENDENCY_OUTPUTS_CONFIG}/" INSTALL_DEPENDENCY_OUTPUTS_FILEPATH "${INSTALL_DEPENDENCY_OUTPUTS_FILEPATH}")

        set(INSTALL_DEPENDENCY_OUTPUTS_FILENAME "${local_path}")
        string(CONFIGURE
[[  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/@INSTALL_DEPENDENCY_OUTPUTS_DESTINATION@/@INSTALL_DEPENDENCY_OUTPUTS_FILENAME@" TYPE FILE FILES "@INSTALL_DEPENDENCY_OUTPUTS_FILEPATH@")]]
          snippet @ONLY)
...
[[if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/@INSTALL_DEPENDENCY_OUTPUTS_DESTINATION@/@INSTALL_DEPENDENCY_OUTPUTS_FILENAME@" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/@INSTALL_DEPENDENCY_OUTPUTS_DESTINATION@/@INSTALL_DEPENDENCY_OUTPUTS_FILENAME@")
    file(RPATH_CHECK
