...
TEST(InteropGeoMatrix4x4FTest, addMatrixAddsMatricesTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), Nrt_GeoMatrix4x4F_getDefaultIdentity(), &actualMatrix, nullptr), NRT_SUCCESS);
...
TEST(InteropGeoMatrix4x4FTest, addMatrixReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), Nrt_GeoMatrix4x4F_getDefaultIdentity(), nullptr, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addMatrixReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addMatrix(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addMatrixReturnsNaNFailureWhenGivenNanMatrixForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractMatrixSubtractsMatricesTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), Nrt_GeoMatrix4x4F_getDefaultIdentity(), &actualMatrix, nullptr), NRT_SUCCESS);
  EXPECT_TRUE(Nrt_GeoMatrix4x4F_equal(*reinterpret_cast<NrtGeoMatrix4x4F*>(&expectedMatrix), actualMatrix));
}
...
TEST(InteropGeoMatrix4x4FTest, subtractMatrixReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), Nrt_GeoMatrix4x4F_getDefaultIdentity(), nullptr, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractMatrixReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractMatrix(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractMatrixReturnsNaNFailureWhenGivenNanMatrixForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyMatrixMultipliesMatricesTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyMatrix(*reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), *reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), &resultMatrix, nullptr), NRT_SUCCESS);
...
TEST(InteropGeoMatrix4x4FTest, multiplyMatrixReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), Nrt_GeoMatrix4x4F_getDefaultIdentity(), nullptr, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyMatrixReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyMatrix(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyMatrixReturnsNaNFailureWhenGivenNanMatrixForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyMatrix(Nrt_GeoMatrix4x4F_getDefaultIdentity(), NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignMatrixAddsMatricesTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignMatrix(reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), *reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), nullptr), NRT_SUCCESS);
...
TEST(InteropGeoMatrix4x4FTest, addAssignMatrixReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignMatrix(nullptr, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignMatrix(&nanInput, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignMatrix(&dummyInput, NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignMatrix(&nanInput, nanInput, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignMatrixSubtractsMatricesTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignMatrix(&inputMatrix, inputMatrix, nullptr), NRT_SUCCESS);
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignMatrixReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignMatrix(nullptr, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignMatrix(&nanInput, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignMatrix(&dummyInput, NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignMatrix(&nanInput, nanInput, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignMatrixMultipliesMatricesTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignMatrix(reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), *reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), nullptr), NRT_SUCCESS);
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignMatrixReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignMatrix(nullptr, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignMatrix(&nanInput, Nrt_GeoMatrix4x4F_getDefaultIdentity(), &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignMatrix(&dummyInput, NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignMatrixReturnsNaNFailureWhenGivenNanMatrixForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignMatrix(&nanInput, nanInput, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addFloatAddsMatrixAndFloatTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_one(), Nrt_GeoVector4F_one(), Nrt_GeoVector4F_one(), Nrt_GeoVector4F_one() }, 1.0f, &actualMatrix, nullptr), NRT_SUCCESS);
  EXPECT_TRUE(Nrt_GeoMatrix4x4F_equal(*reinterpret_cast<NrtGeoMatrix4x4F*>(&expectedMatrix), actualMatrix));
}
...
TEST(InteropGeoMatrix4x4FTest, addFloatReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addFloat(Nrt_GeoMatrix4x4F_getDefaultIdentity(), 1.0f, nullptr, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addFloatReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, 1.0f, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addFloatReturnsNaNFailureWhenGivenNanFloatForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addFloat(Nrt_GeoMatrix4x4F_getDefaultIdentity(), NAN, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addFloatReturnsNaNFailureWhenGivenNanValuesForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, NAN, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractFloatSubtractsMatricxAndFloatTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_one(), Nrt_GeoVector4F_one(), Nrt_GeoVector4F_one(), Nrt_GeoVector4F_one() }, 1.0f, &actualMatrix, nullptr), NRT_SUCCESS);
  EXPECT_TRUE(Nrt_GeoMatrix4x4F_equal(*reinterpret_cast<NrtGeoMatrix4x4F*>(&expectedMatrix), actualMatrix));
}
...
TEST(InteropGeoMatrix4x4FTest, subtractFloatReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractFloat(Nrt_GeoMatrix4x4F_getDefaultIdentity(), 1.0f, nullptr, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractFloatReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, 1.0f, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractFloatReturnsNaNFailureWhenGivenNanFloatForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractFloat(Nrt_GeoMatrix4x4F_getDefaultIdentity(), NAN, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractFloatReturnsNaNFailureWhenGivenNanValuesForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, NAN, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyFloatMultipliesMatrixAndFloatTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyFloat(*reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), 2.0f, &resultMatrix, nullptr), NRT_SUCCESS);
  EXPECT_TRUE(Nrt_GeoMatrix4x4F_equal(*reinterpret_cast<NrtGeoMatrix4x4F*>(&expectedMatrix), resultMatrix));
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyFloatReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyFloat(Nrt_GeoMatrix4x4F_getDefaultIdentity(), 1.0f, nullptr, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyFloatReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, 1.0f, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyFloatReturnsNaNFailureWhenGivenNanFloatForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyFloat(Nrt_GeoMatrix4x4F_getDefaultIdentity(), NAN, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyFloatReturnsNaNFailureWhenGivenNanValuesForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyFloat(NrtGeoMatrix4x4F { Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN), Nrt_GeoVector4F_uniform(NAN) }, NAN, &outputThatDoesntGetUsed, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignFloatAddsMatrixAndFloatTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignFloat(reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), 1.0f, nullptr), NRT_SUCCESS);
  EXPECT_TRUE(Nrt_GeoMatrix4x4F_equal(*reinterpret_cast<NrtGeoMatrix4x4F*>(&expectedMatrix), inputMatrix));
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignFloatReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignFloat(nullptr, 1.0f, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignFloatReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignFloat(&nanInput, 1.0f, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignFloatReturnsNaNFailureWhenGivenNanFloatForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignFloat(&dummyInput, NAN, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, addAssignFloatReturnsNaNFailureWhenGivenNanMatrixForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_addAssignFloat(&nanInput, NAN, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignFloatSubtractsMatrixAndFloatTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignFloat(&inputMatrix, 1.0f, nullptr), NRT_SUCCESS);
  EXPECT_TRUE(Nrt_GeoMatrix4x4F_equal(expectedMatrix, inputMatrix));
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignFloatReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignFloat(nullptr, 1.0f, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignFloatReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignFloat(&nanInput, 1.0f, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignFloatReturnsNaNFailureWhenGivenNanFloatForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignFloat(&dummyInput, NAN, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, subtractAssignFloatReturnsNaNFailureWhenGivenNanValuesForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_subtractAssignFloat(&nanInput, NAN, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignFloatMultipliesMatrixAndFloatTogetherCorrectly) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignFloat(reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix), 2.0f, nullptr), NRT_SUCCESS);
  EXPECT_TRUE(Nrt_GeoMatrix4x4F_equal(*reinterpret_cast<NrtGeoMatrix4x4F*>(&expectedMatrix), *reinterpret_cast<NrtGeoMatrix4x4F*>(&inputMatrix)));
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignFloatReturnsNullptrFailureWhenGivenNullptrForOutput) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignFloat(nullptr, 1.0f, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNullptr(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignFloatReturnsNaNFailureWhenGivenNanMatrixForLhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignFloat(&nanInput, 1.0f, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignFloatReturnsNaNFailureWhenGivenNanFloatForRhs) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignFloat(&dummyInput, NAN, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
...
TEST(InteropGeoMatrix4x4FTest, multiplyAssignFloatReturnsNaNFailureWhenGivenNanValuesForBoth) {
  ...
  ASSERT_EQ(Nrt_GeoMatrix4x4F_multiplyAssignFloat(&nanInput, NAN, &errorMessage), NRT_FAILURE_UNKOWN);
  EXPECT_EQ(Nrt_getErrMsgIsNaN(), errorMessage); 
}
