...
TEST_F(InteropQuadTreeTest, insertFiveDoesSubdivideAndPointsAreCorrect) {
 ...
 TEST_F(InteropQuadTreeTest, getIntersectingPointsReturnsAllPoints) {
   ...
   EXPECT_TRUE(checkPointsForEqualityC(intersectingPoints->at(0), point0));
   EXPECT_TRUE(checkPointsForEqualityC(intersectingPoints->at(1), point4));
   EXPECT_TRUE(checkPointsForEqualityC(intersectingPoints->at(2), point1));
   EXPECT_TRUE(checkPointsForEqualityC(intersectingPoints->at(3), point2));
   EXPECT_TRUE(checkPointsForEqualityC(intersectingPoints->at(4), point3));
 }
