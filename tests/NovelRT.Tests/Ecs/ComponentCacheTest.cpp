...
{
    EXPECT_NO_THROW(cache.RegisterComponentType<int32_t>(static_cast<int32_t>(NAN), "THROW_AWAY"));
}

TEST_F(ComponentCacheTest, GetComponentBufferReturnsValidBuffer)
{
    cache.RegisterComponentType<int32_t>(static_cast<int32_t>(NAN), "THROW_AWAY");
