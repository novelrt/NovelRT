...
namespace NovelRT {
  NovelRunner::NovelRunner(int displayNumber, const std::string& windowTitle, uint32_t targetFrameRate, bool transparency, NovelRT::Windowing::WindowMode initialWindowMode) :
    ...
    _novelWindowingService->initialiseWindow(displayNumber, windowTitle, transparency, initialWindowMode);
