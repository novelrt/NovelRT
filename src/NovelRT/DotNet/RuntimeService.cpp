...
namespace NovelRT::DotNet
{
    RuntimeService::RuntimeService()
        : _hostContextHandle(Lazy<hostfxr_handle>([&, this] {
              ...
              std::filesystem::path runtimeConfigJsonPath =
                  executableDirPath / "dotnet" / "NovelRT.DotNet.runtimeconfig.json";
          ...
          _hostfxr_initialize_for_runtime_config(Lazy<hostfxr_initialize_for_runtime_config_fn>([&, this] {
              return reinterpret_cast<hostfxr_initialize_for_runtime_config_fn>(
                  getNativeExport(_hostfxr.getActual(), "hostfxr_initialize_for_runtime_config"));
          })),
          _hostfxr_get_runtime_delegate(Lazy<hostfxr_get_runtime_delegate_fn>([&, this] {
              return reinterpret_cast<hostfxr_get_runtime_delegate_fn>(
                  getNativeExport(_hostfxr.getActual(), "hostfxr_get_runtime_delegate"));
          })),
          ...
          _load_assembly_and_get_function_pointer(Lazy<load_assembly_and_get_function_pointer_fn>([&, this] {
              ...
              int result = _hostfxr_get_runtime_delegate.getActual()(_hostContextHandle.getActual(),
          ...
          _exports(Lazy<Exports>([&, this] {
              ...
              void* delegate;
              int result = _load_assembly_and_get_function_pointer.getActual()(
                  assembly_path, STR("NovelRT.DotNet.RuntimeService, NovelRT.DotNet"), STR("GetExports"),
                  UNMANAGEDCALLERSONLY_METHOD, nullptr, &delegate);
