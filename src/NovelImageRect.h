...
namespace NovelRT {
    ...
    public:
        NovelImageRect(const float& screenScale, const GeoVector<float>& position, NVGcontext* context, const std::string& imageDir, const float& rotation = 0, const GeoVector<float>& scale = GeoVector<float>(1, 1));
