...
const char* const errMsgIsNullInstanceProvided = "Unable to continue. A null instance was provided when an instance was expected.";
...
const char* const errMsgIsOutOfMemory = "Unable to continue. Insufficient memory to continue the execution of the program.";
