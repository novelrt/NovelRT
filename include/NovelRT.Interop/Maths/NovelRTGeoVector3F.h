...
extern "C" {
  ...
  NovelRTResult NovelRT_GeoVector3F_rotateToAngleAroundPoint(NovelRTGeoVector3F* const vector, float angleRotationValue, NovelRTGeoVector3F point, const char** errorMessage);
