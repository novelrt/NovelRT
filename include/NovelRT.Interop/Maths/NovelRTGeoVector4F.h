...
extern "C" {
  ...
  int32_t NovelRT_GeoVector4F_rotateToAngleAroundPoint(NovelRTGeoVector4F* const vector, float angleRotationValue, NovelRTGeoVector3F point, const char** errorMessage);
