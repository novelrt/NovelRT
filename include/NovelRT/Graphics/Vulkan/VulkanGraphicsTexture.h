...
#ifndef NOVELRT_GRAPHICS_VULKAN_VULKANGRAPHICSTEXTURE_H
#define NOVELRT_GRAPHICS_VULKAN_VULKANGRAPHICSTEXTURE_H
...
#endif // !NOVELRT_GRAPHICS_VULKAN_VULKANGRAPHICSTEXTURE_H
