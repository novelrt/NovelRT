...
#ifndef NOVELRT_EXPERIMENTAL_GRAPHICSPIPELINEINPUT_H
#define NOVELRT_EXPERIMENTAL_GRAPHICSPIPELINEINPUT_H
...
#endif // !NOVELRT_EXPERIMENTAL_GRAPHICSPIPELINEINPUT_H
