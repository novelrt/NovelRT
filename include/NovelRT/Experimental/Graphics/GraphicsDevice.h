...
#ifndef NOVELRT_EXPERIMENTAL_GRAPHICS_GRAPHICSDEVICE_H
#define NOVELRT_EXPERIMENTAL_GRAPHICS_GRAPHICSDEVICE_H
...
#endif // !NOVELRT_EXPERIMENTAL_GRAPHICS_GRAPHICSDEVICE_H
