...
#ifndef NOVELRT_EXPERIMENTAL_GRAPHICS_VULKANSHADERPROGRAM_H
#define NOVELRT_EXPERIMENTAL_GRAPHICS_VULKANSHADERPROGRAM_H
...
#endif // NOVELRT_EXPERIMENTAL_GRAPHICS_VULKANSHADERPROGRAM_H
