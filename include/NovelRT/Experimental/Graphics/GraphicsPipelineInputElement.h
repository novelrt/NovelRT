...
#ifndef NOVELRT_EXPERIMENTAL_GRAPHICSPIPELINEINPUTELEMENT_H
#define NOVELRT_EXPERIMENTAL_GRAPHICSPIPELINEINPUTELEMENT_H
...
#endif // !NOVELRT_EXPERIMENTAL_GRAPHICSPIPELINEINPUTELEMENT_H
