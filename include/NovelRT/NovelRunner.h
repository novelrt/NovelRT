 ...
 */
  ...
  public:
     ...
     */
    explicit NovelRunner(int displayNumber, const std::string& windowTitle = "NovelRTTest", uint32_t targetFrameRate = 0, bool transparency = false, NovelRT::Windowing::WindowMode = NovelRT::Windowing::WindowMode::Windowed);
    /**
