...
namespace NovelRT::Ecs
{
    ...
    private:
        ...
        inline void AddDefaultComponentsAndSystems(SystemScheduler& target)
        {
            ...
            target.GetComponentCache().RegisterComponentType(Narrative::NarrativeStoryStateComponent{Narrative::NarrativeStoryState::Idle, true},
                "NovelRT::Ecs::Narrative::NarrativeStoryStateComponent");
            
            target.GetComponentCache().RegisterComponentType(Narrative::RequestNarrativeScriptExecutionComponent{uuids::uuid(), true},
            ...
            target.RegisterSystem(std::make_shared<Narrative::NarrativePlayerSystem>(_resourceManagementPluginProvider));
