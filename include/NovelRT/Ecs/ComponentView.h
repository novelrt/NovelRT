...
namespace NovelRT::Ecs
{
    ...
    class ComponentView
    {
        ...
        /**
         * @brief Pushes a new Component state as an update instruction into the ComponentBuffer with the current thread context.
         * 
         ...
         * 
         * @exception Exceptions::DuplicateKeyException when multiple update instructions are pushed to this buffer on the same thread.
         */
         ...
         * 
         * This is exactly the same as ComponentView::PushComponentUpdateInstruction, however it takes the component state as an optional parameter.
         * This allows for an implicit default state to be added to the entity in question.
         * 
         ...
         * 
         * This is exactly the same as ComponentView::PushComponentUpdateInstruction if it is provided with the component deletion state.
         * 
        ...
        /**
         * @brief Attempts to add a new component of the given type to the entity with safety checks to ensure it is an exceptionless operation.
         * 
         * This assumes that you have not previously pushed an update instruction to the ComponentBuffer on this thread this frame.
         * If an update instruction was pushed on this thread previously, this will segfault.
         * 
         * @param entity The EntityId to attach the component to.
         * @param initialValue The intitial state of the component. If none is provided, it implicitly defaults to the default state of the component.
        ...
        /**
         * @brief Attempts to remove a component from an entity with safety checks to ensure it is an exceptionless operation.
         * 
         * This assumes that you have not previously pushed an update instruction to the ComponentBuffer on this thread this frame.
         * If an update instruction was pushed on this thread previously, this will segfault.
         * 
         ...
         * @exception std::out_of_range if the given EntityId is not present within the immutable buffer data for this update cycle.
         */
         ...
         * of the underlying buffer. Please see ComponentView::HasComponent for more information.
         *
         * @param entity
         * @return TComponent A copy of the current state of the component attached to the given entity.
         */
