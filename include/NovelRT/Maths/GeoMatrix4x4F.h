...
namespace NovelRT::Maths
{
    ...
    public:
        ...
        {
            *reinterpret_cast<glm::mat4*>(this) = glm::translate(
                *reinterpret_cast<glm::mat4*>(this), NovelRT::Core::Utilities::Misc::BitCast<glm::vec3>(vector));
        }
        ...
        inline void Rotate(float angleInRadians, GeoVector3F rotationAngle = GeoVector3F(0.0f, 0.0f, -1.0f))
        {
            *reinterpret_cast<glm::mat4*>(this) =
                glm::rotate(*reinterpret_cast<glm::mat4*>(this), angleInRadians,
                            NovelRT::Core::Utilities::Misc::BitCast<glm::vec3>(rotationAngle));
        }
        ...
        {
            *reinterpret_cast<glm::mat4*>(this) = glm::scale(
                *reinterpret_cast<glm::mat4*>(this), NovelRT::Core::Utilities::Misc::BitCast<glm::vec3>(scaleValue));
        }
        ...
        [[nodiscard]] inline bool operator==(GeoMatrix4x4F other) const noexcept
        {
            return *reinterpret_cast<const glm::mat4*>(this) ==
                   NovelRT::Core::Utilities::Misc::BitCast<glm::mat4>(other);
        }
        ...
        {
            *reinterpret_cast<glm::mat4*>(this) += NovelRT::Core::Utilities::Misc::BitCast<glm::mat4>(other);
            return *this;
        }
        ...
        {
            return GeoMatrix4x4F(glm::lookAt(NovelRT::Core::Utilities::Misc::BitCast<glm::vec3>(eye),
                                             NovelRT::Core::Utilities::Misc::BitCast<glm::vec3>(centre),
                                             NovelRT::Core::Utilities::Misc::BitCast<glm::vec3>(up)));
        }
    };
}
